...
import com.example.project_11.R
...
import com.example.project_11.ui.viewModel.HomeUiState
...
fun OnError(retryAction: () -> Unit, modifier: Modifier = Modifier) {
    Column(
        ...
        Text(text = stringResource(R.string.loading_filed), modifier = Modifier.padding(16.dp))
